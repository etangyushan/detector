...
#endif
#if 0
	cpu user = 26057 nice = 30 system = 19540 idle = 11578094 6835 108 1405 105627 11683721 cpu = 100 * (cpust.user + cpust.nice + cpust.system) / (cpust.user + cpust.nice + cpust.system + cpust.idle);
	return cpu;
#endif
	return cpust;
}
