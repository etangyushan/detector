...
static yyconst flex_int16_t yy_base[21] =
    {   0,
        0,   14,   18,   20,   20,   20,   20,   11,   20,    0,
        8,    0,    9,    0,    6,    0,   20,   10,    8,    9
    } ;

static yyconst flex_int16_t yy_def[21] =
    {   0,
       17,    1,   17,   17,   17,   17,   17,   18,   17,   18,
       19,   20,   18,   18,   19,   20,    0,   17,   17,   17
    } ;

static yyconst flex_int16_t yy_nxt[30] =
    {   0,
        4,    5,    6,    7,    4,    8,    9,   10,   11,   16,
       15,   16,   14,   14,   13,   14,   13,   17,   12,    3,
...
YY_RULE_SETUP
#line 30 "confl.l"
{yylval.string = strdup(yytext); return SPECIFIER;}
	YY_BREAK
case 4:
YY_RULE_SETUP
#line 31 "confl.l"
